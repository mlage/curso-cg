class GPUCanvas {
    ...
    createTriangle(positions, colors) {
        return this.createShape([positions, colors], 3);
    }

    createBuffer(data, usage, size = null, ArrayType = Float32Array) {
        const source = this.toTypedArray(data, ArrayType);
    ...
    createUniformBuffer(data) {
        const source = this.toTypedArray(data);
    ...
    toTypedArray(data, ArrayType = Float32Array) {
